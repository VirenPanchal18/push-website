...
- **`to` field:** For multicall, the `to` field should always be set to the zero address (`0x0000000000000000000000000000000000000000`). The SDK will `console.warn` if you pass any other address, and this will become mandatory in a future release.
