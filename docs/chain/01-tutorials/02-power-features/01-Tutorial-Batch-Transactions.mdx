...
Check out the next tutorial to learn how to [derive Universal Executor Accounts](/docs/chain/tutorials/power-features/tutorial-derive-universal-executor-account/).