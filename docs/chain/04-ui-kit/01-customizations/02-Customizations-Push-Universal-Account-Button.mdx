...
| `connectButtonClassName`  | `string`          | -                | CSS class applied to the default Connect Wallet button.                                                                                                                                           |
| `connectedButtonClassName`  | `string`          | -                | CSS class applied to the default connected wallet button.                                                                                                                                          |
